# Generated by Django 5.2.1 on 2025-05-11 17:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('diet_preference', models.CharField(blank=True, help_text='E.g., Vegetarian, Vegan, etc.', max_length=255)),
                ('diet_allergies', models.CharField(blank=True, max_length=255)),
                ('diet_restrictions', models.CharField(blank=True, max_length=255)),
                ('diet_preferences', models.CharField(blank=True, help_text='Food preferences', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fitness_level', models.IntegerField(choices=[(1, 'Beginner'), (2, 'Intermediate'), (3, 'Advanced'), (4, 'Expert'), (5, 'Professional')], default=1)),
                ('workout_frequency', models.PositiveIntegerField(help_text='Workouts per week')),
                ('workout_duration', models.PositiveIntegerField(help_text='Average workout duration in minutes')),
                ('workout_intensity', models.PositiveIntegerField(help_text='Scale of 1-10')),
                ('workout_type', models.CharField(max_length=255)),
                ('workout_equipment', models.CharField(blank=True, max_length=255)),
                ('workout_style', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_fat', models.PositiveIntegerField(blank=True, help_text='Body fat percentage', null=True)),
                ('body_mass', models.PositiveIntegerField(blank=True, help_text='Body mass index', null=True)),
